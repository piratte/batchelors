...
metafield is the name of the metadata field, operator is one of the classical comparison operators:
...
catalog features metaqueries evidently is the search for files. For files already stored in databases the DIRAC
...
situation. The conclusion was that applying an ordinary query would not be as big of a problem to 
