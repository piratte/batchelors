...
definovaných dotazem nad metadaty. K vylepšení práce s dotazy v kódu systému, nová třída MetaQuery je vyvinuta,
...
DFC by přineslo vylepšením výkonu vyhledávání. Několik NoSQL databází je otestováno na datech podobných 
...
In the second part of the thesis the hypothesis that connecting the metadata part of the DIRAC File Catalog
could improve metaquery performance is evaluated. Several NoSQL databases are tested and the best performing
is then connected using a interface module to the DFC.
