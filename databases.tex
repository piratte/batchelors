...
\begin{figure}[h]
	...
	\caption{Comparison between MongoDB with indexes created specially for the tested queries (MDB comp) and 
...
\begin{figure}[h]
	...
	\caption{Comparison between Elasticsearch (ES) and the now deployed MySQL on a larger set of queries.}
	\label{fig:wide}
\end{figure}
